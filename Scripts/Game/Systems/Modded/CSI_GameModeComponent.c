...
class CSI_GameModeComponentClass : SCR_BaseGameModeComponentClass {};

class CSI_GameModeComponent : SCR_BaseGameModeComponent
{
	...
	static CSI_GameModeComponent GetInstance()
	{
		BaseGameMode gameMode = GetGame().GetGameMode();
		if (gameMode)
			return CSI_GameModeComponent.Cast(gameMode.FindComponent(CSI_GameModeComponent));
		else
			return null;
	}
